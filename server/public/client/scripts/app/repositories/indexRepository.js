    ...
    function indexRepositoryF(){
        var book = {
                    ...
                    content: [
                        {
                            ...
                            index: 0,
                            text: '2',
                            templateUrl: '../client/pages/function.html',
                            ...
                            content: [
                                {
                                 ...
                                 text: '',
                                 type: 'html/urlTemplate',
                                 templateUrl: '../client/pages/Function/1_functionInitAndCall.html',
                                 content:[{
                                     name: 'Вложенные функции',
                                        text: '',
                                        type: 'html/urlTemplate',
                                        templateUrl: '../client/pages/Function/functionInitAndCall/1_IncludedFunction.html',
                                        content:[
                                    ] },
                                     {
                                         ...
                                         text: '',
                                         type: 'html/urlTemplate',
                                         templateUrl: '../client/pages/Function/functionInitAndCall/2_functonalLiteral.html',
                                         content:[
                                         ] },
                                     {
                                         ...
                                         text: '',
                                         type: 'html/urlTemplate',
                                         templateUrl: '../client/pages/Function/functionInitAndCall/1q_Questions.html',
                                         content:[
                                         ] }
                                 ]
                                },
                                {
                                    ...
                                    text: '',
                                    type: 'html/urlTemplate',
                                    templateUrl: '../client/pages/Function/2_functionArguments.html',
                                    content:[
                                        {
                                            name: 'Необязательные аргументы',
                                            text: '',
                                            type: 'html/urlTemplate',
                                            templateUrl: '../client/pages/Function/functionArguments/1_optionaArguments.html',
                                            content:[
                                            ] },
                                        {
                                            ...
                                            text: '',
                                            type: 'html/urlTemplate',
                                            templateUrl: '../client/pages/Function/functionArguments/2_argumentsList.html',
                                            content:[
                                            ] },
                                        {
                                            ...
                                            text: '',
                                            type: 'html/urlTemplate',
                                            templateUrl: '../client/pages/Function/functionArguments/3_propertyLikeArgument.html',
                                            content:[
                                            ] },
                                        {
                                            name: 'Вопросы для самопроверки',
                                            text: '',
                                            type: 'html/urlTemplate',
                                            templateUrl: '../client/pages/Function/functionArguments/2q_Questions.html',
                                            content:[
                                            ] }
                                    ]
                                },
                                {
                                    ...
                                    text: '',
                                    type: 'html/urlTemplate',
                                    templateUrl: '../client/pages/Function/3_functionLikeData.html',
                                    content:[
                                        {
                                            name: 'Вопросы для самопроверки',
                                            text: '',
                                            type: 'html/urlTemplate',
                                            templateUrl: '../client/pages/Function/FunctionLikeData/3q_Questions.html',
                                            content:[
                                            ] }
                                    ]
                                }
                        ...
                        ,
                        {
                            ...
                            text: '',
                            type: 'html/urlTemplate',
                            templateUrl: '../client/pages/TestPage.html',
                            content:[
                            ]
                        }
            ...
            questions: [
                ...
                {
                    question : 'Выберите синтаксически корректную JavaScript команду для объявления функции, вызванной в виде "callFunction(d,c,a)".',
                    variants : [
            ...
            '/JavaScript: The Definitive Guide/Часть I. Основы JavaScript/Функции/Аргументы функции/Необязательные аргументы'
                ...
                {
                    question : 'Выберите высказывание об описанном далее коде содержащее ошибку. код : var i = function(a,c){};',
                    variants: [
